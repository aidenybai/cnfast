...
test("merges known none values in sizing groups correctly", () => {
  expect(twMerge("max-w-lg max-w-none")).toBe("max-w-none");
  expect(twMerge("max-w-none max-w-lg")).toBe("max-w-lg");
  expect(twMerge("max-h-96 max-h-none")).toBe("max-h-96 max-h-none");
  expect(twMerge("max-h-none max-h-96")).toBe("max-h-none max-h-96");
  expect(twMerge("max-h-[300px] max-h-none")).toBe("max-h-[300px] max-h-none");
  expect(twMerge("max-h-none max-h-screen")).toBe("max-h-none max-h-screen");
});
